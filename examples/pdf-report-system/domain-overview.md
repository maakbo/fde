...
業務担当は業務システムのデータを使って帳票を用意し、業務責任者は内容を確認します。
全体の中にある主な仕事と、そのつながりを一枚で見ます。
...
帳票業務には、データを整えて新しく出力する仕事と、必要な帳票を探して再取得する仕事があります。
この先は[帳票を用意する場面](report-creation-context.md)で、参加する人と扱う情報をもう少し近くから見られます。
