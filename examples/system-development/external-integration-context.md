...
flowchart LR
  ...
  click b_isolate_boundary href "https://github.com/maakbo/fde/blob/main/examples/system-development/external-integration-flow.md" "原因特定の流れを見る"
  click b_verify_contract href "https://github.com/maakbo/fde/blob/main/examples/system-development/interface-specification-detail.md" "外部IF仕様の設計観点を見る"
