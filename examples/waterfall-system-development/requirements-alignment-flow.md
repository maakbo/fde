...
PDF帳票の要求・帳票仕様・外部IFの抜けや矛盾を解き、関係者が合意できる状態まで
繰り返し整える流れです。
...
---
flowchart TB
  b_prepare_review@{ label: "PDF論点整理", img: "https://raw.githubusercontent.com/maakbo/fde/main/assets/icons/lucide-thin/ellipse.svg", pos: "b", w: 30, h: 30, constraint: "on" }
  b_review_requirements@{ label: "帳票要件確認", img: "https://raw.githubusercontent.com/maakbo/fde/main/assets/icons/lucide-thin/ellipse.svg", pos: "b", w: 30, h: 30, constraint: "on" }
  ...
  b_resolve_gap@{ label: "帳票差異解消", img: "https://raw.githubusercontent.com/maakbo/fde/main/assets/icons/lucide-thin/ellipse.svg", pos: "b", w: 30, h: 30, constraint: "on" }
  b_update_requirements@{ label: "PDF要件更新", img: "https://raw.githubusercontent.com/maakbo/fde/main/assets/icons/lucide-thin/ellipse.svg", pos: "b", w: 30, h: 30, constraint: "on" }
...
- **PDF論点整理** — 帳票仕様・外部IF・受入条件で確認すべき抜け・矛盾・判断点を揃える。
- **帳票要件確認** — 業務要件、PDFシステム要件、受入条件の整合を確認する。
- **帳票差異解消** — 合意できない理由を明らかにし、責任者と解決方針を決める。
- **PDF要件更新** — 解決内容を帳票要件へ戻す。
- **基準化** — 合意済みのPDF帳票要件として後続工程が参照できる状態にする。

## この図が表していること

PDF要件レビューは一度の承認作業ではなく、差異があれば要件へ戻って再確認する反復です。合意できた状態だけを後続工程の基準にします。
