...
| [context](context.md) | focused context | business activity | `overview.md / b_manage_intake` | [flow](flow.md) | Actors, information, and outside service around intake | working hypothesis |
